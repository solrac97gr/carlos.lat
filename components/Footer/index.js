            ...
            <LinkList>
              <LinkItem>
                <FooterLink href="/rss.xml" target="_blank" rel="noopener noreferrer">
                  <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ width: '16px', height: '16px', marginRight: '8px', display: 'inline-block' }}>
              ...
              <LinkItem>
                <FooterLink href="/blog">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ width: '16px', height: '16px', marginRight: '8px', display: 'inline-block' }}>
