...
<CodeSnippet language={"bash"} code={"go mod init github.com/solrac97gr/basic-jwt-auth"} />
...
<CodeSnippet language={"bash"} code={"go get github.com/gofiber/jwt/v3"} />

El paquete de JWT de Golang

<CodeSnippet language={"bash"} code={"go get github.com/golang-jwt/jwt/v4"} />
...
<CodeSnippet language={"bash"} code={"go run main.go"} />
