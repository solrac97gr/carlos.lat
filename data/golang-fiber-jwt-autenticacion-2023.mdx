...
<CodeSnipet language={"bash"} code={"go mod init github.com/solrac97gr/basic-jwt-auth"} />
...
<CodeSnipet language={"bash"} code={"go get github.com/gofiber/jwt/v3"} />

El paquete de JWT de Golang

<CodeSnipet language={"bash"} code={"go get github.com/golang-jwt/jwt/v4"} />

Y por último el paquete de Fiber

<CodeSnipet language={"bash"} code={"go get github.com/gofiber/fiber/v2"} />
...
<CodeSnipet route={"./models/models.go"} language={"go"} code={`
package models
...
<CodeSnipet route={"./config/config.go"} language={"go"} code={`
package config
...
<CodeSnipet route={"./middlewares/auth.go"} language={"go"} code={`
package middlewares
...
<CodeSnipet route={"./repository/FindByCredentials.go"} language={"go"} code={`
package repository
...
<CodeSnipet route={"./main.go"} language={"go"} code={`
package main
...
<CodeSnipet language={"bash"} code={"go run main.go"} />
