...
Si exactamente eso fue click bait, Estoy muy feliz con mi primera experiencia desarrolando un pequeño script usando Rust, soy un desarrollador Backend que trabja con Go en la mayor parte del tiempo, tambien un poco de Typescript y Elixir.
