...
image: "https://miro.medium.com/v2/resize:fit:1400/1*1fE5-1-XpFqj7pYyQjXQoQ.png" # You might want to replace this with a more specific image later
tag: "Go, Go Kit, API, Microservices"
...
<img
  ...
  src="https://miro.medium.com/v2/resize:fit:1400/1*1fE5-1-XpFqj7pYyQjXQoQ.png" # Ensure this image URL is correct and accessible
...
<FolderStructure tree={[
    { type: "folder", name: "cmd", children: [
        { type: "folder", name: "server", children: [
            { type: "file", name: "main.go" }
        ]}
    ]},
    { type: "folder", name: "pkg", children: [
        { type: "folder", name: "service", children: [
            { type: "file", name: "service.go" }
        ]},
        { type: "folder", name: "endpoint", children: [
            { type: "file", name: "endpoint.go" }
        ]},
        { type: "folder", name: "transport", children: [
            { type: "file", name: "http.go" }
        ]}
    ]},
