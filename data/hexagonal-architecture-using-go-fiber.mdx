...
abstract: "Si realmente quieres mejorar en el tiempo de desarrollo y especialmente en el tiempo de integración de nuevas tecnologías en tu proyecto definitivamente la Arquitectura Hexagonal es la mejor decision."
...
<small>15 de Noviembre del 2021</small><EditPost path="hexagonal-architecture-using-go-fiber" />

<img width="100%" alt="golang wallpaper" src="https://miro.medium.com/max/1400/1*xofqkz49chC9XliDAuH1Qw.png"></img>
...
El repositorio de usuario se comunicara directamente con la base de datos, asie que en la funcion de creación (NewUserRepository) podemos agregar la inicialización de la base de datos, para este ejemplo usaré mongo.
...
<BlogLink url={"https://github.com/solrac97gr/goHexagonalBlog"} content={"Visitar el repo"}/>