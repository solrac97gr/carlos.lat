...
<CodeSnippet language="go" route="./internal/core/domain/user.go"  code={`
  package domain
...
<CodeSnippet language="go" route="./internal/core/ports/user_ports.go" code={`
  package ports
...
<CodeSnippet language="go" route="./internal/core/services/user_services.go" code={`
  package services
...
<CodeSnippet language="go" route="./internal/repository/user_repositories.go" code={`
...
<CodeSnippet language="go" route="./internal/handlers/user_handlers.go" code={`
  package handlers
...
<CodeSnippet language="go" route="./internal/server/server.go" code={`
  package server
...
<CodeSnippet route={"./cmd/main"} language="go" code={`
    package main
