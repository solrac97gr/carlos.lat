...
Para este tutorial usaremos dos programas <BlogLink url="https://code.visualstudio.com/download" content="Visual Studio Code"/> y Google Chrome. Si ustedes ya están familiarizados con otro navegador como Firefox y Safari no tienen de que preocuparse e igual podrán usarlo.
