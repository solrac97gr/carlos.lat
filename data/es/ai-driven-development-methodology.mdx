...
<MermaidDiagram code={`
flowchart TD
    Start([🚀 INICIO: Nueva Feature])

    Start ==>|Paso 1| Phase1Start

    subgraph Phase1["📋 FASE 1: Requisitos y Planificación - HUMANO"]
        direction TB
        Phase1Start[" "]
        PRD[Product Owner<br/>Crea PRD]
        Split[Ingeniero Senior<br/>Divide Features]
        Phase1Start ~~~ PRD
        PRD --> Split
        Split --> Phase1End[" "]
    end

    Phase1End ==>|Paso 2| Phase2Start

    subgraph Phase2["🧪 FASE 2: Especificación y Testing - AGENTE IA"]
        direction TB
        Phase2Start[" "]
        Gherkin[Agente: PRD a<br/>Specs Gherkin]
        Tests[Agente: Gherkin a<br/>Archivos de Test]
        Phase2Start ~~~ Gherkin
        Gherkin --> Tests
        Tests --> Phase2End[" "]
    end

    Phase2End ==>|Paso 3| Phase3Start

    subgraph Phase3["🔨 FASE 3: Implementación - AGENTE IA"]
        direction TB
        Phase3Start[" "]
        Implement[Agente: Tests a<br/>Implementación]
        QA[Agente: Revisión QA<br/>& Corrección]
        PR[Agente: Crear PR<br/>& Documentación]
        Phase3Start ~~~ Implement
        Implement --> QA --> PR
        PR --> Phase3End[" "]
    end

    Phase3End ==>|Paso 4| Phase4Start

    subgraph Phase4["🚀 FASE 4: Revisión y Release - HUMANO + IA"]
        direction TB
        Phase4Start[" "]
        Review[Humano + Agente:<br/>Code Review]
        SemiProd[Agente: Testing<br/>Semi-Producción]
        Issues[Agente: Crear<br/>Issues en GitHub]
        Phase4Start ~~~ Review
        Review --> SemiProd
        SemiProd -->|Errores| Issues
        SemiProd -->|Todo Bien| Phase4End[" "]
    end

    Phase4End ==> Deploy([✅ DEPLOY A PRODUCCIÓN])
    Issues -.->|Correcciones| Phase2Start
...
<MermaidDiagram code={`
flowchart LR
    PRD["📄 Feature del PRD<br/>(desde Notion)"]
    Agent1["🤖 Agente 1:<br/>PRD → Gherkin"]
    Gherkin["📝 Spec Gherkin<br/>(archivo .feature)"]
    Agent2["🤖 Agente 2:<br/>Gherkin → Tests"]
    Tests["✅ Archivos de Test<br/>(.test.js)"]

    NotionMCP[(Notion MCP<br/>Contexto de Negocio)]

    PRD --> Agent1
    NotionMCP -.->|Contexto| Agent1
    Agent1 --> Gherkin
    Gherkin --> Agent2
    NotionMCP -.->|Plantillas| Agent2
    Agent2 --> Tests

    Tests -.->|Listo para<br/>Implementación| Phase3[Fase 3]
...
graph TB
    subgraph Sources["📚 Fuentes de Conocimiento"]
        Notion[(Notion<br/>Docs de Negocio<br/>Estándares de Código<br/>Docs Técnicos)]
        Context7[(Context7<br/>Docs de Librerías<br/>Docs de Frameworks)]
        Playwright[(Playwright<br/>Testing en Navegador<br/>Screenshots)]
        GitHub[(GitHub<br/>Issues & PRs<br/>Repositorio)]
    end
    ...
    subgraph Agents["🤖 Agentes IA"]
        GherkinAgent[Agente de<br/>Specs Gherkin]
        TestAgent[Agente de<br/>Generación Tests]
        ImplAgent[Agente de<br/>Implementación]
        QAAgent[Agente de<br/>Revisión QA]
        PRAgent[Agente de<br/>PR & Docs]
        ReleaseAgent[Agente de<br/>Testing Release]
    end

    Notion -->|Contexto en Vivo| NotionMCP
    Context7 -->|Docs Actualizados| Context7MCP
    Playwright -->|Interfaz Testing| PlaywrightMCP
    GitHub -->|Acceso Repositorio| GitHubMCP

    NotionMCP -.->|PRD, Reglas Negocio| GherkinAgent
    NotionMCP -.->|Plantillas| TestAgent
    NotionMCP -.->|Docs Técnicos| ImplAgent
    Context7MCP -.->|Docs Librerías| ImplAgent
    NotionMCP -.->|Estándares Código| QAAgent
    PlaywrightMCP -.->|Tests Navegador| QAAgent
    NotionMCP -.->|Plantillas PR| PRAgent
    GitHubMCP -.->|Creación Issues| ReleaseAgent
...
<MermaidDiagram code={`
graph LR
    Level1["🎯 Nivel 1<br/>Solo Fase 3<br/><br/>✅ Implementación IA<br/>✅ Contexto MCP<br/>⏱️ Resultados Rápidos"]
    Level2["🎯 Nivel 2<br/>+ Fase 2<br/><br/>✅ Specs Gherkin<br/>✅ Generación Tests<br/>✅ TDD Impuesto"]
    Level3["🎯 Nivel 3<br/>+ Fase 4<br/><br/>✅ Revisión Asistida<br/>✅ Testing Semi-Prod<br/>✅ Ciclo de Feedback"]
    Level4["🎯 Nivel 4<br/>+ Fase 1<br/><br/>✅ Pipeline Completo<br/>✅ PRD a Producción<br/>🚀 Flujo Completo"]

    Level1 -->|Agregar Especificación| Level2
    Level2 -->|Agregar Revisión & Release| Level3
    Level3 -->|Agregar Requisitos| Level4
