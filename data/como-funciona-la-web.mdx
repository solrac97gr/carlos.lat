...
<small>5 de Julio del 2022</small> 
...
2. Acto seguido esta solicitud se topa con el primer reto yo quiero ir a YouTube.com pero como se donde está el servidor ubicado pues el DNS(un gran libro de direcciones) se encarga de decirnos la dirección exacta del servidor( la IP).
