...
<CodeSnippet language="markdown" route="methodology-overview.md" code={`Phase 1: Requirements & Planning ........... [HUMAN]
  ...
  → CTO/Staff/Sr Engineer splits features

Phase 2: Specification & Testing ........... [AI AGENT]
  → Agent converts PRD features into Gherkin specs
  → Agent generates test files from Gherkin

Phase 3: Implementation .................... [AI AGENT]
  → Agent implements features (test-first)
  → Agent runs QA review and fixes issues
  → Agent creates PR and documentation

Phase 4: Review & Release .................. [HUMAN + AI]
  → Human + Agent perform assisted code review
  → Agent tests released features in semi-prod
  → Agent creates GitHub issues if errors found`} />
...
<CodeSnippet language="markdown" route="mcp-overview.md" code={`MCP Server          │ Used By                    │ Provides
────────────────────┼────────────────────────────┼─────────────────────────────
Notion MCP          │ Almost all agents          │ Business docs, code standards,
                    │                            │ tech docs, PRD, templates
────────────────────┼────────────────────────────┼─────────────────────────────
Context7            │ Implementation agent       │ Up-to-date library and
                    │                            │ framework documentation
────────────────────┼────────────────────────────┼─────────────────────────────
Playwright MCP      │ QA agent                   │ Real browser testing,
                    │                            │ screenshots, test reports
────────────────────┼────────────────────────────┼─────────────────────────────
GitHub MCP          │ Release testing agent      │ Issue creation, PR management,
